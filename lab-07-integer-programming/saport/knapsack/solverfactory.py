    ...
    def solver(type: SolverType, problem: Problem, timelimit: int) -> Solver:
        return defaultdict(
            Solver, {
                ...
                SolverType.IMPLICIT_ENUM: IntegerImplicitEnumerationSolver(problem, timelimit),
                SolverType.LINEAR_RELAX: IntegerLinearRelaxationSolver(problem, timelimit)
            })[type]
